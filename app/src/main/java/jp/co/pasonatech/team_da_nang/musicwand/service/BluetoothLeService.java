package jp.co.pasonatech.team_da_nang.musicwand.service;
...
import jp.co.pasonatech.team_da_nang.musicwand.common.GattInfo;
...
//import pasonatech.danang.util.Adapter.PreferenceWR;
...
public class BluetoothLeService extends Service {
    ...
    private pasonatech.danang.util.Adapter.PreferenceWR mDevicePrefs = null;
    ...
    public boolean connect(final String address) {
        ...
        this.mDevicePrefs = new pasonatech.danang.util.Adapter.PreferenceWR(device.getAddress(),this.getApplicationContext());
